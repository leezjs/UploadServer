...
-- 
-- Host: localhost
-- Generation Time: Mar 30, 2014 at 09:31 AM
...
-- 
-- Table structure for table `tbusertoken_template`
-- 
...
-- 
-- Table structure for table `tbuseruploadfile_template`
-- 
...
CREATE TABLE `tbuseruploadfile_template` (
  ...
  `sFileSavePath` varchar(512) NOT NULL,
  `dtUploadTime` datetime NOT NULL,
  `iStatus` tinyint(4) NOT NULL COMMENT '0未同步，1已同步, 2为同步失败',
  PRIMARY KEY  (`id`),
  KEY `iUserId` (`iUserId`,`iFileType`,`iStatus`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
